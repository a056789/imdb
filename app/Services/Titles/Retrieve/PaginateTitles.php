...
class PaginateTitles
{
    ...
    public function execute($params)
    {
        ...
        if ($genre = $paginator->param('genre')) {
            ...
            $paginator->query()->whereIn('titles.id', function(\Illuminate\Database\Query\Builder $query) use($genres) {
        ...
        if ($paginator->param('orderBy') === 'rating') {
            $paginator->setParam('orderBy', config('common.site.rating_column'));
        }
